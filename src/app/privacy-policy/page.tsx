        ...
        <div className="space-y-10">
          ...
          <Section title="1. Information We Collect">
            <Subsection title="Information you provide">
              <ul className="list-disc pl-6 space-y-2 body-md text-muted-foreground">
                <li><strong className="text-foreground">Account information:</strong> When you register, we collect your name, email address, and password.</li>
                <li><strong className="text-foreground">Profile information:</strong> Username, profile picture, and banner image you choose to upload.</li>
                <li><strong className="text-foreground">Event types:</strong> Titles, descriptions, durations, and availability windows you configure.</li>
                <li><strong className="text-foreground">Booking information:</strong> When someone books time with you, we collect the invitee&apos;s name, email address, and any optional notes they provide.</li>
                <li><strong className="text-foreground">Calendar integration:</strong> If you connect Google Calendar, we store a refresh token to read and write calendar events on your behalf.</li>
              </ul>
            </Subsection>
            <Subsection title="Information collected automatically">
              <ul className="list-disc pl-6 space-y-2 body-md text-muted-foreground">
                <li><strong className="text-foreground">Usage data:</strong> Pages visited, features used, and timestamps of activity.</li>
          ...
          <Section title="2. How We Use Your Information">
            <ul className="list-disc pl-6 space-y-2 body-md text-muted-foreground">
              ...
              <li>To send transactional emails such as booking confirmations, cancellations, and reschedule notifications.</li>
          ...
          <Section title="3. How We Share Your Information">
            ...
            <ul className="list-disc pl-6 space-y-2 body-md text-muted-foreground">
              <li><strong className="text-foreground">Service providers:</strong> Third-party vendors (e.g., email delivery, cloud hosting) that help us operate the Service, subject to confidentiality obligations.</li>
              <li><strong className="text-foreground">Google:</strong> When you use the Google Calendar integration, data is shared with Google in accordance with their privacy policy.</li>
          ...
          <Section title="4. Data Retention">
            <p className="body-md text-muted-foreground">
              We retain your account information for as long as your account is active. Booking records are
              retained for a minimum of 12 months to support dispute resolution and reporting. You may
          ...
          <Section title="5. Security">
            <p className="body-md text-muted-foreground">
              ...
              in transit, and secure token storage. No method of transmission over the internet is 100% secure,
          ...
          <Section title="7. Cookies">
            <p className="body-md text-muted-foreground">
              We use localStorage to store your authentication session. We do not use third-party tracking
              cookies. We may use first-party cookies for essential functionality such as maintaining your
              login state.
            </p>
          </Section>
